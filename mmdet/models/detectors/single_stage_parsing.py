...
class SingleStageInsParsingDetector(BaseDetector):
    ...
    def init_weights(self, pretrained=None):
        super(SingleStageInsParsingDetector, self).init_weights(pretrained)
    ...
    def forward_train(self,
        ...
        if self.with_mask_feat_head:
            ...
            loss_inputs = outs + (mask_feat_pred, gt_bboxes, gt_labels, gt_masks, gt_parsing, img_metas, self.train_cfg)
        else:
            loss_inputs = outs + (gt_bboxes, gt_labels, gt_masks, gt_parsing, img_metas, self.train_cfg)
