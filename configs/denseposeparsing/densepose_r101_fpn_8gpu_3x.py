...
train_pipeline = [
    ...
    dict(type='LoadAnnotations', with_bbox=True, with_mask=True, with_parsing=True),
    dict(type='Resize',
...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'annotations/DensePose_COCO/densepose_coco_2014_test.json',
        img_prefix=data_root + 'images/val2017/',
        pipeline=test_pipeline))
# optimizer
...
log_level = 'INFO'
work_dir = './work_dirs/densepose_release_r101_fpn_8gpu_3x'
load_from = None
resume_from = None
workflow = [('train', 1)]
